...
public static class StringExtender
{
    ...
    /// <returns></returns>
    private static readonly string[] DATE_TIME_FORMATS = new string[3]
        { "yyyyMMdd-HH:mm:ss.ffffff", "yyyyMMdd-HH:mm:ss.fff", "yyyyMMdd-HH:mm:ss" };

    private static readonly CultureInfo DATE_TIME_CULTURE_INFO = CultureInfo.InvariantCulture;

    private static readonly DateTimeStyles DATE_TIME_STYLES =
