...
public static class ListViewItemSelectedBehavior
{
    public static readonly DependencyProperty CommandProperty =
        DependencyProperty.RegisterAttached("Command", typeof(ICommand), typeof(ListViewItemSelectedBehavior),
    ...
    private static void OnCommandChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is ListView listView)
        {
            ...
            if (e.NewValue != null) listView.PreviewMouseLeftButtonDown += ListView_PreviewMouseLeftButtonDown;
        }
    }
    ...
    private static void ListView_PreviewMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
    {
        ...
        {
            var item = ItemsControl.ContainerFromElement(listView,
            ...
            if (item != null)
            {
                ...
                if (command?.CanExecute(listView.SelectedItem) == true) command.Execute(listView.SelectedItem);
            }
        }
    }
}