...
public class HelperMath
{
    ...
    public static List<PointF> LinearRegression(List<PointF> points)
    {
        ...
        var sumX = 0D; // Sum of x values
        var sumY = 0D; // Sum of y values
        var sumX2 = 0D; // Sum of x-squared values
        var sumXY = 0D; // Sum of the products of x*y
        double m = 0D, b = 0D;
        ...
        var aRet = new List<PointF>();
        var point1 = new PointF();
        var point2 = new PointF();
        point1.X = points.Min(x => x.X);
        point1.Y = (float)(m * point1.X + b);
        point2.X = points.Max(x => x.X);
