...
{
    public static double CalculateRealizedPnL(List<Order> buys, List<Order> sells,
        PositionManagerCalculationMethod method)
    {
        double realizedPnL = 0;
        var buyOrders = method == PositionManagerCalculationMethod.FIFO
            ? buys.OrderBy(o => o.CreationTimeStamp).ToList()
            : buys.OrderByDescending(o => o.CreationTimeStamp).ToList();
        var sellOrders = method == PositionManagerCalculationMethod.FIFO
            ? sells.OrderBy(o => o.CreationTimeStamp).ToList()
            : sells.OrderByDescending(o => o.CreationTimeStamp).ToList();
    ...
    public static double CalculateOpenPnL(List<Order> buys, List<Order> sells, PositionManagerCalculationMethod method,
